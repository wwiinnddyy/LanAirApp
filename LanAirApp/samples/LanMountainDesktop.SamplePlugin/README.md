...
这是官方示例插件仓库 `LanMountainDesktop.SamplePlugin` 的镜像模板副本，用于 `LanAirApp` 内部文档、SDK 联调和样例起步。

### 角色说明

- 这里保留可构建的镜像样例代码
- 这里的 `plugin.json` 与示例代码应跟随官方示例仓库同步到 `3.0.0`
...
- keep the manifest and sample code aligned with the official sample at API `3.0.0`
